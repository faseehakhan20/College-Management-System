	...
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				...
				<div class="row">
					<div class="col-md-12">
						<form action="courses.php" method="post" id="form">
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">Course Code: </label>
										<input type="varchar" name="course_code" class="form-control" required placeholder="Enter Course Code">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" name="semester_or_year" class="form-control" required placeholder="Enter Semester Or Years">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputPassword1">No of Years:</label>
										<input type="number" name="no_of_year" class="form-control" required  placeholder="Enter No of Years">
									</div>
								</div>
							</div>
							<div class="row w-100">
...
<script>
  $(document).ready(function () {
    $('#form').validate({
      ...
      messages: {
        course_code: 'Please enter course_code.',
        course_name: 'Please enter Name.',
        semester_or_year: {
          required: 'Please enter number.',
          rangelength: 'Contact should be 1-4 digit number.',
        },
        no_of_year: {
          required: 'Please enter number.',
          minlength: 'no_of_years must be at least 1 characters long.',
        }
